      ...
      <div className="container-custom">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            {/* Timeline Rail (slightly slower = background feel) */}
            <Parallax speed={0.96} as="div" className="absolute left-8 top-0 bottom-0">
              <div className="w-0.5 h-full bg-gradient-to-b from-primary-500 via-purple-500 to-primary-500"></div>
            </Parallax>

            {/* Items container (neutral) */}
            <Parallax speed={1.0} as="div" className="space-y-12">
              {allItems.map((item, index) => (
                <Parallax
                  key={index}
                  // alternate subtle speeds per item for depth
                  speed={index % 2 === 0 ? 1.03 : 0.99}
                  lag={0.08 + (index % 3) * 0.04}
                  as="div"
                  className="relative"
                >
                  <motion.div
