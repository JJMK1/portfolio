...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-hero">
      {/* Enhanced Animated Background (moves slower than content) */}
      ...
      <div className="container-custom relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Left Column - Text Content (slightly faster = foreground emphasis) */}
          <Parallax speed={1.05} lag={0.12} as="div">
            ...
            >
              ...
              >
                <TextType text="Jericho E. Tupaz" typingSpeed={130} className="inline-block text-white" />
              </motion.h1>
              ...
              >
                ...
                <a href="/assets/Resume_Tupaz, Jericho.pdf" download className="btn-secondary flex items-center gap-2 group">
                  <Download size={20} />
                  Download Resume
                </a>
              </motion.div>
          ...
          {/* Right Column - Profile Image (slightly slower than text) */}
          <Parallax speed={0.98} lag={0.06} as="div" className="flex justify-center lg:justify-end">
            <motion.div
              initial={{ opacity: 0, x: 50 }}
              animate={{ opacity: 1, x: 0 }}
        ...
        {/* Scroll Indicator (neutral speed) */}
